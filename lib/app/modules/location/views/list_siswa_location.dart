...
class ListUserLocationView extends GetView<ListSiswaLocationController> {
  const ListUserLocationView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBar(title: "Siswa yang diluar sekolah"),
      body: controller.obx(
        (state) => state != null
  ...
  Widget cardSiswa(UserData siswa) {
    return InkWell(
      onTap: () {
        Get.toNamed(Routes.LOCATION, arguments: siswa);
      },
      child: Container(
