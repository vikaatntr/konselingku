...
class AppRoutes {
  ...
  static final pages = [
    ...
    GetPage(name: _Paths.HOME_APPOINTMENT, page: () => homeAppointment()),
    GetPage(name: _Paths.COUNSELING_APPOINTMENT, page: () => appointmentPage()),
    GetPage(name: _Paths.REKAP_COUNSELING, page: () => rekapKonseling()),
    GetPage(name: _Paths.FORM_APPOINTMENT, page: () => formAppointment()),
    GetPage(name: _Paths.HASIL_KONSELING, page: () => hasilKonseling()),
